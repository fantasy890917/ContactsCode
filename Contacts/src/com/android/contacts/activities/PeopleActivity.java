...
public class PeopleActivity extends ContactsActivity implements
    ...
    public PeopleActivity() {
        Log.d(TAG, "PeopleActivity.PeopleActivity()");
    ...
    public void onAttachFragment(Fragment fragment) {
        Log.d(Constants.PERFORMANCE_TAG, "PeopleActivity.onAttachFragment()");
    ...
    protected void onNewIntent(Intent intent) {
        Log.d(TAG, "PeopleActivity.onNewIntent()");
        setIntent(intent);
    ...
    private void registerReceiver() {
        Log.d(TAG, "PeopleActivity.registerReceiver()");
    ...
    private boolean processIntent(boolean forNewIntent) {
        Log.d(TAG, "PeopleActivity.processIntent()");
    ...
    private void createViewsAndFragments(Bundle savedState) {
        Log.d(TAG, "PeopleActivity.createViewsAndFragments()");
    ...
    protected void onStart() {
        Log.d(TAG, "PeopleActivity.onStart()");
    ...
    protected void onPause() {
        Log.d(TAG, "PeopleActivity.onPause()");
        mOptionsMenuContactsAvailable = false;
        mProviderStatusWatcher.stop();
        super.onPause();
        //annotated by baoyilin for ICE2-1590 2017-06-12
    ...
    public void onAttachedToWindow() {
        Log.d(TAG, "PeopleActivity.onAttachedToWindow()");
    ...
    protected void onStop() {
        Log.d(TAG, "PeopleActivity.onStop()");
        if (mActionBarAdapter != null) {
    ...
    private void restoreExportToSimProgressBar() {
        Log.d(TAG, "PeopleActivity.restoreExportToSimProgressBar()");
    ...
    protected void onDestroy() {
        Log.d(TAG, "PeopleActivity.onDestroy()");
    ...
    private void configureFragments(boolean fromRequest) {
        Log.d(TAG, "PeopleActivity.configureFragments()");
        if (fromRequest) {
    ...
    public void onContactListFilterChanged() {
        Log.d(TAG, "PeopleActivity.onContactListFilterChanged()");
    ...
    public void onAction(int action) {
        Log.d(TAG, "PeopleActivity.onAction()");
        switch (action) {
    ...
    public void onSelectedTabChanged() {
        ...
        Log.d(TAG, "PeopleActivity.onSelectedTabChanged()");
        updateFragmentsVisibility();
    ...
    public void onUpButtonPressed() {
        ...
        Log.d(TAG, "PeopleActivity.onUpButtonPressed()");
        onBackPressed();
    ...
    public void onPopupItemClick(boolean selectAll) {
        Log.d(TAG, "PeopleActivity.onPopupItemClick()");
    ...
    private void updateFragmentsVisibility() {
        Log.d(TAG, "PeopleActivity.updateFragmentsVisibility()");
    ...
    private class TabPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrollStateChanged(int state) {
            Log.d(TAG, "TabPagerListener.onPageScrollStateChanged()");
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            Log.d(TAG, "TabPagerListener.onPageScrolled()");
            if (!mTabPagerAdapter.areTabsHidden()) {
        ...
        public void onPageSelected(int position) {
            Log.d(TAG, "TabPagerListener.onPageSelected()");
    ...
    private class TabPagerAdapter extends PagerAdapter {
        ...
        public TabPagerAdapter() {
            Log.d(TAG, "TabPagerAdapter.TabPagerAdapter()");
    ...
    public void startActivityAndForwardResult(final Intent intent) {
        Log.d(TAG, "PeopleActivity.startActivityAndForwardResult()");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        Log.d(TAG, "PeopleActivity.onCreateOptionsMenu()");
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        Log.d(TAG, "PeopleActivity.onPrepareOptionsMenu()");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.d(TAG, "PeopleActivity.onOptionsItemSelected()");
    ...
    public boolean onSearchRequested() { // Search key pressed.
        Log.d(TAG, "PeopleActivity.onSearchRequested()");
        if (!mActionBarAdapter.isSelectionMode()) {
    ...
    public void onContactsJoined() {
        ...
        Log.d(TAG, "PeopleActivity.onContactsJoined()");
        mActionBarAdapter.setSelectionMode(false);
    }
    ...
    public void onDeletionFinished() {
        ...
        Log.d(TAG, "PeopleActivity.onDeletionFinished()");
        mActionBarAdapter.setSelectionMode(false);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d(TAG, "PeopleActivity.onActivityResult()");
        switch (requestCode) {
...
//                break;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        Log.d(TAG, "PeopleActivity.onKeyDown()");
    ...
    public void onBackPressed() {
        Log.d(TAG, "PeopleActivity.onBackPressed()");
    ...
    protected void onSaveInstanceState(Bundle outState) {
        Log.d(TAG, "PeopleActivity.onSaveInstanceState()");
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        Log.d(TAG, "PeopleActivity.onRestoreInstanceState()");
    ...
    public DialogManager getDialogManager() {
        ...
        Log.d(TAG, "PeopleActivity.getDialogManager()");
        return mDialogManager;
    }

    @Override
    public void onClick(View view) {
        Log.d(TAG, "PeopleActivity.onClick()");
        switch (view.getId()) {
