...
public class ExpandingEntryCardView extends CardView {
    ...
    private static final int DURATION_EXPAND_ANIMATION_FADE_IN = 100; ///M: 200->100 for performance
    private static final int DURATION_COLLAPSE_ANIMATION_FADE_OUT = 50; ///M: 75->50 for performance
    private static final int DELAY_EXPAND_ANIMATION_FADE_IN = 50; ///M: 100->50 for performance

    public static final int DURATION_EXPAND_ANIMATION_CHANGE_BOUNDS = 150; ///M: 300->150 for performance
    public static final int DURATION_COLLAPSE_ANIMATION_CHANGE_BOUNDS = 200; ///M: 300->200 for performance
    ...
    private static final class EntryTouchListener implements View.OnTouchListener {
        ...
        // Modified by HQ.ShengXianshui 2017.06.02 start.
        // FIX issue ICE2-1328
        // In QuickContactActivity, no response when clicking some contact item.
        // When VT icon shows, this method always return true. Then "onClick"
        ...
        // Modified by HQ.ShengXianshui 2017.06.02 end.
    }
}
