...
public class CompactContactEditorFragment extends ContactEditorBaseFragment implements
    ...
    ///M: fix ICE15-1445 at 2017/06/22 @{
    private static final String KEY_IS_PHOTO_REMOVED = "is_photo_removed";
    ///M: @}
    ...
    //modify by hanwei for bug ICE2-1248 begin 20170607
    private Uri photoUri = null;
    //modify by hanwei for bug ICE2-1248 end 20170607
    ///M: fix ICE15-1445 at 2017/06/22 @{
    private boolean mIsPhotoRemoved = false;
    ///M: @}
    ...
    public void onCreate(Bundle savedState) {
        ...
        if (savedState != null) {
            ///M: fix ICE15-1445 at 2017/06/22 @{
            mIsPhotoRemoved = savedState.getLong(KEY_IS_PHOTO_REMOVED) == 1 ? true : false;
            ///M: @}
    ...
    public void onSaveInstanceState(Bundle outState) {
        ///M: fix ICE15-1445 at 2017/06/22 @{
        outState.putLong(KEY_IS_PHOTO_REMOVED, mIsPhotoRemoved ? 1 : 0);
        ///M: @}
    ...
    protected void bindEditors() {
        ...
        //modify by hanwei for bug ICE2-1248 begin 20170607
        if(photoUri != null && !SimContactsConstants.ACCOUNT_TYPE_SIM.equals(
                    mState.get(0).getAccountType())) {
            editorView.setFullSizePhoto(photoUri);
        }
        //modify by hanwei for bug ICE2-1248 end 20170607

        ///M: fix ICE15-1445 at 2017/06/22 @{
        //Log.i("zql1590", "mIsPhotoRemoved:" + mIsPhotoRemoved);
        if (mIsPhotoRemoved) {
            editorView.setFullSizePhoto(null);
