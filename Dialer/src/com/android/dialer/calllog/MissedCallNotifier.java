...
public class MissedCallNotifier {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (UserManagerCompat.isUserUnlocked(mContext)) {
                    ...
                    /* [ICE15-822] change by Sven start, add IMS WIFI */
                    where.append(" = 1 AND (");
                    ...
                    try {
                        mContext.getContentResolver().update(Calls.CONTENT_URI, values,
                                where.toString(), new String[]{
                                        ...
                                        Integer.toString(Calls.MISSED_IMS_TYPE),
                                        Integer.toString(Calls.MISSED_WIFI_TYPE)});
                    } catch (IllegalArgumentException e) {
                        Log.w(TAG, "ContactsProvider update command failed", e);
                    }
                    /* [ICE15-822] change by Sven end */
                }
    ...
    public void callBackFromMissedCall(String number) {
        /* [ICE15-427] add by Sven start */
        try {
            WindowManagerGlobal.getWindowManagerService().dismissKeyguard();
        } catch (RemoteException e) {
        }
        /* [ICE15-427] add by Sven end */
