...
public class DialtactsActivity extends TransactionSafeActivity implements View.OnClickListener,
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (!isRtl && tabIndex == ListsFragment.TAB_INDEX_SPEED_DIAL && !mIsLandscape) {
            ///M:[ICE15-1247] The FAB always show at right by Nieyong start {@
            mFloatingActionButtonController.onPageScrolled(1);
            ///M:[ICE15-1247] The FAB always show at right by Nieyong end   @}
    ...
    private int getFabAlignment() {
        if (!mIsLandscape && !isInSearchUi() &&
            ...
            // Added by baoyilin for ICE2-1912 2017-06-22 start
            /*if(isInMultiWindowMode()) {
                return FloatingActionButtonController.ALIGN_END;
            }*/
            // Added by baoyilin for ICE2-1912 2017-06-22 end
    ...
    //add by ICE15-541 zhangzhen 20170622 start
    @Override
    protected void onDestroy() {
        if (mOverflowMenu != null && isInMultiWindowMode()) {
    ...
    public void onMultiWindowModeChanged(boolean isInMultiWindowMode) {
        //if (isInMultiWindowMode){ ///M: fix ICE15-1601 at 2017/06/28
            mOverflowMenu.dismiss();
        //}
    }
    //add by ICE15-541 zhangzhen 20170622 end
}
