...
public class VideoCallPresenter extends Presenter<VideoCallPresenter.VideoCallUi> implements
    ...
    private void exitVideoMode() {
        ...
        enableCamera(mVideoCall, false);
        /* [ICE15-2180] add by Sven start */
        final InCallCameraManager cameraManager = InCallPresenter.getInstance().
                getInCallCameraManager();
        cameraManager.setUseFrontFacingCamera(true);
        /* [ICE15-2180] add by Sven end */
    ...
    private void showVideoUi(int videoState, int callState, boolean isConf) {
        ...
        if (showIncomingVideo || showOutgoingVideo) {
            ...
            // Modified by ShengXianshui 2017.06.30 start.
            // JIRA: ICE2-1967 in VT conference, hangup one VT and start
            // another VT, the self video can't be shown for the new VT.
            // Qualcomm solution, case ID:03015145
            /*
            if (hidePreview) {
                ui.showOutgoingVideoView(!hidePreview);
            }*/
            ui.showOutgoingVideoView(!hidePreview
                    && (mPictureModeHelper != null
                            && mPictureModeHelper.canShowPreviewVideoView()));
            // Modified by ShengXianshui 2017.06.30 end.
