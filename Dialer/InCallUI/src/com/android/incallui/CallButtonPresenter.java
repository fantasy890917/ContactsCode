...
public class CallButtonPresenter extends Presenter<CallButtonPresenter.CallButtonUi>
    ...
    public void toggleSpeakerphone() {
        ...
        if (VideoProfile.isVideo(mCall.getVideoState()) && newMode == CallAudioState.ROUTE_WIRED_OR_EARPIECE) {
            if (InCallPresenter.getInstance().getProximitySensor() != null) {
                InCallPresenter.getInstance().getProximitySensor().onInCallShowing(false);
            }
        }
    ...
    private void updateButtonsState(Call call) {
        ...
        /* [ICE15-2262] add by Sven start, do not display when dialing */
        final boolean showDowngradeToAudio = isVideo
                && isDowngradeToAudioSupported(call)
                && !Call.State.isDialing(call.getState());
        /* [ICE15-2262] add by Sven end */
        ...
        //modify by hw for bug ICE2-1656 begin 20170624
        boolean showUpdateVideoButton = call.can(android.telecom.Call.Details.CAPABILITY_MANAGE_CONFERENCE);
        ui.showButton(BUTTON_UPGRADE_TO_VIDEO, showUpgradeToVideo && !mEnhanceEnable && !showUpdateVideoButton);
        //modify by hw for bug ICE2-1656 end 20170624
        ...
        //ICE2-1754 remove add partivipant button by customer request liukun20170617 start
        ui.showButton(BUTTON_ADD_PARTICIPANT, false);//showAddParticipant && !mEnhanceEnable);
        //ICE2-1754 remove add partivipant button by customer request liukun20170617 end
