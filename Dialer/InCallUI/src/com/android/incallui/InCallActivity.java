...
public class InCallActivity extends TransactionSafeActivity implements FragmentDisplayManager {
    ...
    //modify by zhuqi for bug ICE2-1334 begin 20170605
    public static final String CONFIG_TEXT_EXTRA = "InCallActivity.config";
    //modify by zhuqi for bug ICE2-1334 end 20170605
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //modify by zhuqi for bug ICE2-1334 begin 20170605
        if (icicle != null) {
            Configuration config = (Configuration)icicle.getParcelable(CONFIG_TEXT_EXTRA);
            if(config!=null){
                getResources().getConfiguration().updateFrom(config);
            }
        }
        mOldConfig = getResources().getConfiguration();
        mIsLandscape = mOldConfig.orientation == Configuration.ORIENTATION_LANDSCAPE;
        //modify by zhuqi for bug ICE2-1334 end 20170605
    ...
    protected void onSaveInstanceState(Bundle out) {
        ...
        out.putParcelable(CONFIG_TEXT_EXTRA, mOldConfig);//modify by zhuqi for bug ICE2-1334 begin 20170605
...
//    }
    ...
    protected void onDestroy() {
        ...
        /* [ICE15-3164] add by Sven start */
        dismissPendingDialogs();
        /* [ICE15-3164] add by Sven end */
    ...
    public void finish() {
        ...
        overridePendingTransition(0, 0);//modify by zhuqi for bug ICE2-1413 begin 20170606
    }
