    ...
    private void turnOffProximitySensor(boolean screenOnImmediately) {
        if (mProximityWakeLock != null) {
            if (mProximityWakeLock.isHeld()) {
                ...
                ///Add by fanta for ICE15-2374:when call end, but the sensor is positive, screenOnImmediately is false, and call state is NO_CALLS
				/// should release ProximitySensor and turn on screen
                int flags = 0;
                ///@}
