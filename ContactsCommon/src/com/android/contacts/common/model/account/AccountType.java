...
public abstract class AccountType {
    ...
    public static Drawable getDisplayIcon(Context context, int titleRes, int iconRes,
        ...
        if (titleRes != -1 && syncAdapterPackageName != null) {
            ...
            //wangxiaoyu modify for ICE15-212 start
            if(iconRes == R.drawable.ic_account_circle_black_24dp){
                Drawable drawable = context.getResources().getDrawable(iconRes);
                android.support.v4.graphics.drawable.DrawableCompat.setTint(drawable,
                        android.support.v4.content.ContextCompat.getColor(context, R.color.editor_icon_color));
                return drawable;
            }
