...
public abstract class ContactEntryListFragment<T extends ContactEntryListAdapter>
    ...
    //modify by zhuqi for bug ICE2-1190 begin 20170602
    private static final String KEY_LISTVIEWTOPINDEX = "listViewTopIndex";
    private static final String KEY_LISTVIEWTOPOFFSET = "listViewTopOffset";
    //modify by zhuqi for bug ICE2-1190 end 20170602
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        //modify by zhuqi for bug ICE2-1190 begin 20170602
        outState.putInt(KEY_LISTVIEWTOPINDEX, mListViewTopIndex);
        outState.putInt(KEY_LISTVIEWTOPOFFSET, mListViewTopOffset);
        //modify by zhuqi for bug ICE2-1190 end 20170602
        if (mListView != null) {
    ...
    public void restoreSavedState(Bundle savedState) {
        ...
        //modify by zhuqi for bug ICE2-1190 begin 20170602
        mListViewTopIndex = savedState.getInt(KEY_LISTVIEWTOPINDEX);
        mListViewTopOffset = savedState.getInt(KEY_LISTVIEWTOPOFFSET);
        //modify by zhuqi for bug ICE2-1190 end 20170602
